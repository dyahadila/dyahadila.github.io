...
But that doesn't mean pre-MLP steering isn't interesting. In fact, it has a neat connection to in-context learning. In this blog we are going to discuss interesting things we learned about pre-MLP steering during the project. Note that we draw conclusions from a relatively limited set of experiments and analysis, not as rigorous as ones we did in the paper. Mainly:
...
<div style="display: flex; justify-content: center; margin: 2rem 0;">
  <img src="{{ '/assets/img/pre_mlp_blog/steering_sites.png' | relative_url }}" alt="Jintervention sites" style="width:100%; height: auto;" />
</div>